...
examples = [
    ...
    {"sentence": "이거 진찌 별로네요.", "result": "감정: 부정 / 점수: 2"},
...
# 최종 분석할 문장
target = "오랫동안 만난 친구랑 좋은 시간을 보냈어요. 다음에 또 보고 싶네요."
fewshot_text = fewshot_prompt.format(sentence=target)

# print(fewshot_text)
result = chain.invoke({'fewshot_text': fewshot_prompt})
print("문장: ", target)
print("결과: ", result)
