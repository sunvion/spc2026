...
SYSTEM = (
    "도구는 적합할 때만 사용하세요. 그리고 입력 인자들을 잘 확인하고, 오류가 없도록 호춣하시오. 호출 이후 오류가 발생한 경우 도구의 목적과 인자값을 잘 확인하고 재시도하시오. 그러나 재시도는 최대 2회만 하시오. 적합한 도구를 발견하지 못했을 경우, '해당 작업을 수행할 수 있는 도구가 없습니다.' 라고 답변한다."
)
